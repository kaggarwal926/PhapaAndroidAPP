...
public class MyorgNotificationAdapter extends RecyclerView.Adapter<MyorgNotificationAdapter.ViewHolder> {
    ...
    public MyorgNotificationAdapter(Context context, ArrayList<String> notificationArrayTitle, ArrayList<String> notificationArrayDescription, ArrayList<String> notificationArrayNotificationID, ArrayList<String> notificationArrayReplyAllowed, ArrayList<String> notificationOrgIdfk, ArrayList<String> notificationMsgTo) {
